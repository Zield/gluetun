...
let regions = [];
regions[0] = 'Australia Sydney';
regions[1] = 'Australia Brisbane';
regions[2] = 'Australia Adelaide';
regions[3] = 'Australia Perth';
regions[4] = 'Canada Toronto';
regions[5] = 'Canada Montreal';
regions[6] = 'France Paris';
regions[7] = 'Hong Kong';
regions[8] = 'Japan Tokyo';
regions[9] = 'Malaysia';
regions[10] = 'New Zealand';
